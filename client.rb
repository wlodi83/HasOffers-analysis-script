...
@ams_provision_discrepancy_when_different = 0
@hasoffers_provision_discrepancy_when_different = 0
        ...
        if result.empty?
          ...
          puts "subid: " + "#{row[13]}"
            ...
            if result[0][3] != row[9]
              ...
              @ams_provision_discrepancy_when_different = result[0][3] - row[9]
              @hasoffers_provision_discrepancy_when_different = row[9] - result[0][3]
...
puts "Discrepency between AMS and HasOffers which is generated by different communicated provisions: #{@ams_provision_discrepancy_when_different}"
puts "Dicrepancy between HasOffers and AMS which is generated by different communicated provisions: #{@hasoffers_provision_discrepancy_when_different}"
...
File.open('has_offers_result.txt', 'w') do |f|
  ...
  f.puts "Discrepency between AMS and HasOffers which is generated by different communicated provisions: " + "#{@ams_provision_discrepancy_when_different}" + "\n"
  f.puts "Dicrepancy between HasOffers and AMS which is generated by different communicated provisions: " + "#{@hasoffers_provision_discrepancy_when_different}" + "\n"
end
